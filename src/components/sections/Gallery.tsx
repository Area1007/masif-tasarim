...
type GalleryItem = { src: string; alt: string; project: string; slug: string };
      ...
      <Container>
        <div className="grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-6">
            <Eyebrow>Proje Galerisi</Eyebrow>
          ...
          <Reveal delay={120} className="lg:col-span-4 lg:col-start-9 lg:self-end">
            <p className="text-[15px] leading-relaxed text-paper/60">
              Tamamlanan projelerimizden seçilmiş kareler. Büyütmek için görsele dokunun.
            </p>
          </Reveal>
        </div>
